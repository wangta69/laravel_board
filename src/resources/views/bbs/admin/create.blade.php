...
<div class="bbs-admin">
  @if (isset($table->id))
  <h2>@lang('bbs::messages.admin.bbs.edit')</h2>
  <form method="POST" action="{{route('bbs.admin.update', [$table->id]) }}" class="form-horizontal">
    @method('PUT')
    @else
  <h2>@lang('bbs::messages.admin.bbs.create')</h2>
  ...
  <div class='form-group row mt-1'>
      ...
      <div class='col-sm-10 row'>
          <div class="col-auto">
              ...
              <label class="form-check-label">
              @lang('bbs::messages.admin.bbs.enable-reply')
              </label>
          </div>
          <div class="col-auto">
          ...
          <div class="col-auto">
              ...
              <label class="form-check-label">
              @lang('bbs::messages.admin.bbs.enable-password')
              </label>
